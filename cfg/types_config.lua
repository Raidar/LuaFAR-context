...
local types = {
  ...
  txt       = { inherit = 'plain', desc = 'Text',
    ...
    txt_dist  = { inherit = 'txt', desc = 'Install text', -- Distribution kit
                  masks = {'^read%.?me$','^faq.-$','^install.-$','^todo.-$',
                           '^.-changelog.-$','^copying.-$','^license.-$','^authors.-$'} },
              -- rare
  ...
  irclog    = { inherit = 'plain', desc = 'IRC log', masks = {'%.irclog$'} },
      ...
      -- 1.2. rich text --
          ...
          -- 1.2.1. config text --
  ini       = { inherit = 'config', desc = 'INI config', masks = {'%.ini$','%.cfg$'} },
  ...
  cfg_lua   = { inherit = 'config', desc = 'Lua-ini config',
    ...
    ini_dlf   = { inherit = 'ini', desc = 'Delphi ini', -- Delphi config:
                  masks = {'%.dof$','%.dsk$','%.dro$','%.dci$'}, firstline = {lines.ini} },
  ...
  tex      = { inherit = 'markup', desc = 'TeX',
               masks = {'%.tex$','%.sty$','%.cls$'}, firstline = {'^%s-%%'} }, -- <-^ ??
  latex    = { inherit = 'tex', desc = 'LaTeX', masks = {'%.lt[xr]$','%.dtx$'} },
  ...
  farmenu  = { inherit = 'far', desc = 'FAR Menu', masks = {'%.farmenu.?%.ini$'} },
                  -- rare
  --[[
  ...
  html_doc = { inherit = 'html', desc = 'HTML doc', masks = {masks.html},
               firstline = {'^%s*<HTML', '^%s*<!DOCTYPE%s+HTML', '^%s*<!%-%-'} },
  xhtml   = { inherit = 'html', desc = 'XHTML',
              masks = msets.xhtml }, -- , firstline = {lines.xml}
  xhtml_f = { inherit = 'xhtml', desc = 'XHTML Frameset',
              masks = msets.xhtml, firstline = {lines.dtd_xhtml..'Frameset'} },
  xhtml_s = { inherit = 'xhtml', desc = 'XHTML Strict',
              masks = msets.xhtml, firstline = {lines.dtd_xhtml..'Strict'} },
  xhtml_t = { inherit = 'xhtml', desc = 'XHTML Transitional',
              masks = msets.xhtml, firstline = {lines.dtd_xhtml..'Transitional'} },
  ...
  xslfo   = { inherit = 'xml', desc = 'XSLFO', masks = {'%.xsltfo?$','%.fo$'} }, -- 1.0
  xslt    = { inherit = 'xml', desc = 'XSLT', masks = {'%.xslt?2?$'},
              firstline = {'stylesheet%s+', '[tT]ransform%s+'} }, -- 1.0 & 2.0
  ...
  docbook = { inherit = 'xmlbook', desc = 'DocBook', masks = {'%.dbk?$','%.docbook$'},
              firstline = {'DocBook XML','DOCTYPE article','<book','<article'} },
  fb2     = { inherit = 'xmlbook', desc = 'FictionBook',
              masks = {'%.fb2$'}, firstline = {'FictionBook xmlns'} },
              -- XML others: -- MAYBE: somes are SGML subsets (MathML?)!
  calcset = { inherit = 'xml', desc = 'FAR calcset', masks = {'calcset%.csr$'} },
  htc     = { inherit = 'xml', desc = 'HTC', masks = {'%.htc$'} },
  rdf     = { inherit = 'xml', desc = 'RDF', masks = {'%.rdf$'} },
  relaxng = { inherit = 'xml', desc = 'Relax NG', masks = {'%.rng$'} },
  ...
  mathml  = { inherit = 'sgml', desc = 'MathML',
              masks = {'%.mml$','%.math?$'}, firstline = {'MathML'} }, -- 2.0
  ...
  clr_bkt = { inherit = 'colorer', desc = 'Colorer bracket', masks = {'%.bkt%'} },
  clr5cat = { inherit = 'colorer', desc = 'Colorer5 catalog',
              masks = {'catalog%.xml$'}, firstline = {'DTD Colorer CATALOG'} },
  clr_x2h = { inherit = 'colorer', desc = 'xsd2hrc.custom',
              masks = {'custom%..-%.xml$'}, firstline = {'uri:colorer:custom'} },
  ...
  asm     = { inherit = 'main', desc = 'Assembler', masks = {'%.asm$','%.mac$'} },
  ...
  fortran = { inherit = 'main', desc = 'Fortran',
              masks = {'%.for$','%.f$','%.f90$','%.f77$'}, firstline = {'^%*', '^C'} }, -- conflict -^
  idl     = { inherit = 'main', desc = 'IDL', masks = {'%.hvs$','%.[io]dl$'},
              firstline = {lines.c_rem, lines.s_inc} },
  java    = { inherit = 'main', desc = 'Java', masks = {'%.java$','%.ja[vd]$'} },
  pascal  = { inherit = 'main', desc = 'Pascal',
              masks = {'%.~?pas$','%.~?[bdlp]p[rk]$','%.pp$'} },
  pas_inc = { inherit = 'pascal', masks = {masks.inc,'%.i16$','%.i32$','%.int$'} },
  perl    = { inherit = 'main', desc = 'Perl',
              masks = {'%.pl[sx]?$','%.pm$','%.pod$','%.cgi$','%.t$'},
              strongline = {'^#!%s-%S*perl'}, firstline = {'perl'} },
  python  = { inherit = 'main', desc = 'Python',
              masks = {'%.py[ws]?$'}, strongline = {'^#!%s-%S*python'} },
  ruby    = { inherit = 'main', desc = 'Ruby',
              masks = {'%.rbw?$','%.ruby$','%.rake$'},
              strongline = {'^#!%s-%S*ruby'},
              firstline = {'%-%*%- ruby %-%*%-','Rakefile$'} },
  ...
  php     = { inherit = 'net', desc = 'PHP',
              masks = {'%.php%d?$','%.[pt]html$'}, strongline = {'^#%s-%S*php'} },
  ...
  jsp     = { inherit = 'net', desc = 'Java Server Pages', masks = {'%.jspf?$'} },
  ...
  s3dmax = { inherit = 'script', desc = '3D Max script', masks = {'%.mel$','%.ms$'} },
  sflex  = { inherit = 'script', desc = 'FlexScript', -- conflict with flex
             masks = {'%.src$','%.in[ct]$'}, firstline = {'%*%*%*%*%*%*%*%*%*%*'} },
  --]]
  ...
  bin     = { inherit = 'exec', desc = 'Binary code',
              masks = {'%.exe$','%.com$','%.so$','%.dll$','%.lib$', '^io%.sys$'} },
  ...
  arc     = { inherit = 'arch', desc = 'Archive',
              masks = {'%.rar$','%.7z$','%.7zip$','%.zip$','%.t?gz$','%.bz2$',
                       '%.[jt]ar$','%.[ra]%d%d$',
                       '%.arj$','%.lzh$','%.ha$','%.wsz$','%.ace$','%.j$','%.z$' } },
  ...
  graphic_r = { inherit = 'image', desc = 'Picture graphics', group = 'rare',
                masks = {'%.face?$','%.fpx$','%.g[34]$','%.i?lbm$','%.jpc$',
                         ...
                         '%.vic$','%.vicar$'} },
  --picture = { inherit = 'image', desc = 'Picture image', masks = {'%.pmb$'} },
  --]]
          -- 2.3.2. audio --
  ...
  movie   = { inherit = 'video', desc = 'Movie video',
              masks = {'%.mp[4g]?$','%.mpeg?$','%.wmv$','%.cdv$','%.vob$','%.vqa$',
                       '%.bik$','%.smk$'} },
  flash   = { inherit = 'video', desc = 'Flash media', masks = {'%.swf$','%.fl[av]$'} },
              -- rare
  --[[
  ...
  mso_xml = { inherit = 'doc', desc = 'MS Office XML document', group = 'xml_zip',
              masks = {'%.do[ct][xm]$','%.xl[sta][xm]$','%.pp[tsa][xm]$','%.v[dsa]x$'} },
  ...
  xps = { inherit = 'doc', desc = 'XML Paper Specification', group = 'xml_zip',
          masks = {'%.xps$'} },
  lotus = { inherit = 'doc', desc = 'Lotus 123 document',
            masks = {'%.wj[23]$','%.wk[34]$','%.123$'} },
  dvi = { inherit = 'doc', desc = 'TeX DVI document', masks = {'%.x?dvi$','%.xdvik$'} },
  pdf = { inherit = 'doc', desc = 'Adobe PDF document', masks = {'%.e?pdf$'} },
              -- Composed help:
